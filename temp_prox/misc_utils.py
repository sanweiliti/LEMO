...
class JointMapper(nn.Module):
    ...
    def forward(self, joints, **kwargs):
        if self.joint_maps is None:
            ...
            return torch.index_select(joints, 1, self.joint_maps)  # Returns a new tensor which indexes the input tensor along dimension dim using the entries in index which is a LongTensor
